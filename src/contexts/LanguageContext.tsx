  ...
  sq: {
    ...
    services: {
      ...
      items: {
        ...
        couples: {
          title: "Pushim për Çifte",
          description:
            "Ndani një eksperiencë qetësuese me të dashurin tuaj në suitën tonë private për çifte me trajtime të dyfishta.",
        },
        meditation: {
          title: "Meditim & Joga",
          description:
    ...
    pricing: {
      ...
      treatments: {
        swedishMassage: "Masazh Relaksues Suedez",
        deepTissue: "Masazh i Thellë i Indeve",
        hotStone: "Terapi me Gurë të Nxehtë",
        aromatherapyMassage: "Masazh Aromaterapie",
        signatureMassage: "Masazhi Sensea",
        classicFacial: "Trajtim Klasik Pastrues",
        hydratingFacial: "Trajtim Hidratues me Shkëlqim",
        antiAging: "Rinovim Anti-Plakje",
        organicFacial: "Trajtim Organik Ndriçues",
        bodyWrap: "Mbështjellje Detoksifikuese Trupi",
        saltScrub: "Scrub Eksfoliant me Kripë",
        hydratingCocoon: "Kokon Hidratues",
        bodyPolish: "Lustrim dhe Shkëlqim i Plotë Trupi",
        halfDay: "Pushim Gjysmë Ditor",
        fullDay: "Strehë Dite e Plotë",
        couplesHarmony: "Harmonia e Çiftit",
